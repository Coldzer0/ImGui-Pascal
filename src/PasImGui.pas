...
Type
  ...
  Public
    ...
    Class Procedure SetAllocatorFunctions(alloc_func: ImGuiMemAllocFunc; free_func: ImGuiMemFreeFunc;
      user_data: Pointer);
    ...
    Class Function DockSpaceOverViewport(dockspace_id: ImGuiID; Const viewport: PImGuiViewport;
      flags: ImGuiDockNodeFlags; Const window_class: PImGuiWindowClass): ImGuiID;
    ...
    Class Function Selectable(label_: AnsiString; selected: Boolean; flags: ImGuiSelectableFlags = 0): Boolean;
      Overload;
...
Class Procedure ImGui.SetAllocatorFunctions(alloc_func: ImGuiMemAllocFunc; free_func: ImGuiMemFreeFunc;
  user_data: Pointer);
Begin
...
Class Function ImGui.DockSpaceOverViewport(dockspace_id: ImGuiID; Const viewport: PImGuiViewport;
  flags: ImGuiDockNodeFlags; Const window_class: PImGuiWindowClass): ImGuiID;
Begin
  Result := igDockSpaceOverViewport(dockspace_id, ViewPort, flags, window_class);
End;
...
Class Function ImGui.DockBuilderSplitNode(node_id: ImGuiID; split_dir: ImGuiDir;
  size_ratio_for_node_at_dir: Single; out_id_at_dir: PImGuiID; out_id_at_opposite_dir: PImGuiID): ImGuiID;
Begin
...
Class Procedure ImGui.DockBuilderDockWindow(Const window_name: PAnsiChar; node_id: ImGuiID);
Begin
...
Class Procedure ImGui.SetKeyEventNativeData(key: ImGuiKey; native_keycode: Int32; native_scancode: Int32;
  native_legacy_index: Int32);
Begin
...
Class Function ImGui.BeginChild(str_id: AnsiString; size: ImVec2; child_flags: ImGuiChildFlags;
  extra_flags: ImGuiWindowFlags): Boolean;
Begin
  Result := igBeginChild_Str(PAnsiChar(str_id), size, child_flags, extra_flags);
End;

Class Function ImGui.BeginChildEx(id: ImGuiID; size: ImVec2; child_flags: ImGuiChildFlags;
  extra_flags: ImGuiWindowFlags): Boolean;
Begin
...
Class Procedure ImGui.SetNextWindowSizeConstraints(size_min: ImVec2; size_max: ImVec2;
  custom_callback: ImGuiSizeCallback; custom_callback_data: pointer);
Begin
...
Class Procedure ImGui.TextUnformatted(Const _text: PAnsiChar; Const text_end: PAnsiChar);
Begin
...
Class Procedure ImGui.Image(user_texture_id: ImTextureID; size: ImVec2; uv0: ImVec2; uv1: ImVec2;
  tint_col: ImVec4; border_col: ImVec4);
Begin
  igImage(user_texture_id, size, uv0, uv1, tint_col, border_col);
End;

Class Function ImGui.ImageButton(str_id: PAnsiChar; user_texture_id: ImTextureID; size: ImVec2;
  uv0: ImVec2; uv1: ImVec2; bg_col: ImVec4; tint_col: ImVec4): Boolean;
Begin
...
Class Procedure ImGui.PlotLines(_label: PAnsiChar; values: Psingle; values_count: Longint;
  values_offset: Longint; overlay_text: PAnsiChar; scale_min: Single; scale_max: Single;
  graph_size: ImVec2; stride: Longint);
Begin
...
Class Procedure ImGui.PlotHistogram(_label: PAnsiChar; values: Psingle; values_count: Longint;
  values_offset: Longint; overlay_text: PAnsiChar; scale_min: Single; scale_max: Single;
  graph_size: ImVec2; stride: Longint);
Begin
...
Class Function ImGui.BeginCombo(Const _label, preview_value: AnsiString; flags: ImGuiComboFlags): Boolean;
Begin
...
Class Function ImGui.Combo(_label: AnsiString; current_item: PInteger; items: PPAnsiChar;
  items_count: Longint; height_in_items: Longint): Boolean;
Begin
  Result := igCombo_Str_arr(PAnsiChar(_label), current_item, items, items_count, height_in_items);
End;

Class Function ImGui.Combo2(_label: AnsiString; current_item: PInteger; items_separated_by_zeros: PAnsiChar;
  height_in_items: Longint): Boolean;
Begin
...
Class Function ImGui.ColorPicker4(_label: PAnsiChar; col: PSingle; flags: ImGuiColorEditFlags;
  ref_col: PSingle): Boolean;
Begin
...
{ Widgets: Sliders (tip: ctrl+click on a slider to input text) }
Class Function ImGui.SliderFloat(_label: PAnsiChar; v: Psingle; v_min: Single; v_max: Single;
  display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
...
Class Function ImGui.SliderFloat2(_label: PAnsiChar; v: PSingle; v_min: Single; v_max: Single;
  display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  If display_format = nil Then
    display_format := '%.3f';
...
Class Function ImGui.SliderFloat3(_label: PAnsiChar; v: PSingle; v_min: Single; v_max: Single;
  display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  If display_format = nil Then
    display_format := '%.3f';
...
Class Function ImGui.SliderFloat4(_label: PAnsiChar; v: PSingle; v_min: Single; v_max: Single;
  display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  If display_format = nil Then
    display_format := '%.3f';
...
Class Function ImGui.SliderAngle(_label: PAnsiChar; v_rad: Psingle; v_degrees_min: Single;
  v_degrees_max: Single; format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  If format = nil Then
    format := '%.0f deg';
...
Class Function ImGui.SliderInt(_label: PAnsiChar; v: PInteger; v_min: Longint; v_max: Longint;
  display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igSliderInt(_label, v, v_min, v_max, display_format, flags);
End;

Class Function ImGui.SliderInt2(_label: PAnsiChar; v: PInteger; v_min: Longint; v_max: Longint;
  display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igSliderInt2(_label, v, v_min, v_max, display_format, flags);
End;

Class Function ImGui.SliderInt3(_label: PAnsiChar; v: PInteger; v_min: Longint; v_max: Longint;
  display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igSliderInt3(_label, v, v_min, v_max, display_format, flags);
End;

Class Function ImGui.SliderInt4(_label: PAnsiChar; v: PInteger; v_min: Longint; v_max: Longint;
  display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igSliderInt4(_label, v, v_min, v_max, display_format, flags);
End;

Class Function ImGui.VSliderFloat(_label: PAnsiChar; size: ImVec2; v: Psingle; v_min: Single;
  v_max: Single; display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igVSliderFloat(_label, size, v, v_min, v_max, display_format, flags);
End;

Class Function ImGui.VSliderInt(_label: PAnsiChar; size: ImVec2; v: PInteger; v_min: Longint;
  v_max: Longint; display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
...
Class Function ImGui.DragFloat(_label: PAnsiChar; v: Psingle; v_speed: Single; v_min: Single;
  v_max: Single; display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igDragFloat(_label, v, v_speed, v_min, v_max, display_format, flags);
End;

Class Function ImGui.DragFloat2(_label: PAnsiChar; v: PSingle; v_speed: Single; v_min: Single;
  v_max: Single; display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igDragFloat2(_label, v, v_speed, v_min, v_max, display_format, flags);
End;

Class Function ImGui.DragFloat3(_label: PAnsiChar; v: PSingle; v_speed: Single; v_min: Single;
  v_max: Single; display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igDragFloat3(_label, v, v_speed, v_min, v_max, display_format, flags);
End;

Class Function ImGui.DragFloat4(_label: PAnsiChar; v: PSingle; v_speed: Single; v_min: Single;
  v_max: Single; display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igDragFloat4(_label, v, v_speed, v_min, v_max, display_format, flags);
End;

Class Function ImGui.DragFloatRange2(_label: PAnsiChar; v_current_min: Psingle; v_current_max: Psingle;
  v_speed: Single; v_min: Single; v_max: Single; display_format: PAnsiChar; display_format_max: PAnsiChar;
...
End;
{ If v_max >= v_max we have no bound }
Class Function ImGui.DragInt(_label: PAnsiChar; v: PInteger; v_speed: Single; v_min: Longint;
  v_max: Longint; display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igDragInt(_label, v, v_speed, v_min, v_max, display_format, flags);
End;

Class Function ImGui.DragInt2(_label: PAnsiChar; v: PInteger; v_speed: Single; v_min: Longint;
  v_max: Longint; display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igDragInt2(_label, v, v_speed, v_min, v_max, display_format, flags);
End;

Class Function ImGui.DragInt3(_label: PAnsiChar; v: PInteger; v_speed: Single; v_min: Longint;
  v_max: Longint; display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igDragInt3(_label, v, v_speed, v_min, v_max, display_format, flags);
End;

Class Function ImGui.DragInt4(_label: PAnsiChar; v: PInteger; v_speed: Single; v_min: Longint;
  v_max: Longint; display_format: PAnsiChar; flags: ImGuiSliderFlags): Boolean;
Begin
  Result := igDragInt4(_label, v, v_speed, v_min, v_max, display_format, flags);
End;

Class Function ImGui.DragIntRange2(_label: PAnsiChar; v_current_min: PInteger; v_current_max: PInteger;
  v_speed: Single; v_min: Longint; v_max: Longint; display_format: PAnsiChar; display_format_max: PAnsiChar;
  flags: ImGuiSliderFlags): Boolean;
Begin
...
{ Widgets: Input }
Class Function ImGui.InputText(Const label_: PAnsiChar; buf: PAnsiChar; buf_size: NativeUInt;
  flags: ImGuiInputTextFlags; callback: ImGuiInputTextCallback; user_data: Pointer): Boolean;
Begin
  Result := igInputText(label_, buf, buf_size, flags, callback, user_data);
End;

Class Function ImGui.InputTextMultiline(_label: PAnsiChar; buf: PAnsiChar; buf_size: NativeUInt;
  size: ImVec2; flags: ImGuiInputTextFlags; callback: ImGuiInputTextCallback; user_data: pointer): Boolean;
Begin
  Result := igInputTextMultiline(_label, buf, buf_size, size, flags, callback, user_data);
End;

Class Function ImGui.InputFloat(_label: PAnsiChar; v: Psingle; step: Single; step_fast: Single;
  format: PAnsiChar; extra_flags: ImGuiInputTextFlags): Boolean;
Begin
  Result := igInputFloat(_label, v, step, step_fast, format, extra_flags);
End;

Class Function ImGui.InputFloat2(_label: PAnsiChar; v: PSingle; format: PAnsiChar;
  extra_flags: ImGuiInputTextFlags): Boolean;
Begin
  Result := igInputFloat2(_label, v, format, extra_flags);
End;

Class Function ImGui.InputFloat3(_label: PAnsiChar; v: PSingle; format: PAnsiChar;
  extra_flags: ImGuiInputTextFlags): Boolean;
Begin
  Result := igInputFloat3(_label, v, format, extra_flags);
End;

Class Function ImGui.InputFloat4(_label: PAnsiChar; v: PSingle; format: PAnsiChar;
  extra_flags: ImGuiInputTextFlags): Boolean;
Begin
  Result := igInputFloat4(_label, v, format, extra_flags);
End;

Class Function ImGui.InputInt(_label: PAnsiChar; v: PInteger; step: Longint; step_fast: Longint;
  extra_flags: ImGuiInputTextFlags): Boolean;
Begin
...
Class Function ImGui.TreeNodeEx(str_id: PAnsiChar; flags: ImGuiTreeNodeFlags; fmt: AnsiString;
...
Class Function ImGui.TreeNodeEx(ptr_id: pointer; flags: ImGuiTreeNodeFlags; fmt: AnsiString;
  args: Array Of Const): Boolean;
Begin
...
{ Widgets: Table }
Class Function ImGui.BeginTable(Const str_id: PAnsiChar; column: Integer; flags: ImGuiTableFlags;
  outer_size: ImVec2; inner_width: Single): Boolean;
Begin
  Result := igBeginTable(str_id, column, flags, outer_size, inner_width);
End;

Class Function ImGui.BeginTable(Const str_id: PAnsiChar; column: Integer; flags: ImGuiTableFlags): Boolean;
Begin
  Result := BeginTable(str_id, column, flags, ImVec2.New(0, 0), Single(0.0));
End;
...
Class Procedure ImGui.TableSetupColumn(Const label_: PAnsiChar; flags: ImGuiTableColumnFlags;
  init_width_or_weight: Single; user_id: ImGuiID);
Begin
...
{ Widgets: Selectable / Lists }
Class Function ImGui.Selectable(_label: AnsiString; selected: Boolean; flags: ImGuiSelectableFlags;
  size: ImVec2): Boolean;
Begin
...
Class Function ImGui.SelectableEx(_label: PAnsiChar; p_selected: PBoolean; flags: ImGuiSelectableFlags;
  size: ImVec2): Boolean;
Begin
  Result := igSelectable_BoolPtr(_label, p_selected, flags, size);
End;

Class Function ImGui.ListBox(_label: PAnsiChar; current_item: PInteger; items: PPAnsiChar;
  items_count: Longint; height_in_items: Longint): Boolean;
Begin
...
Class Function ImGui.BeginTabBar(Const str_id: PAnsiChar; flags: ImGuiTabBarFlags): Boolean;
Begin
  Result := igBeginTabBar(str_id, flags);
End;

Class Function ImGui.BeginTabItem(Const label_: PAnsiChar; p_open: PBoolean; flags: ImGuiTabItemFlags): Boolean;
Begin
...
Class Function ImGui.CalcTextSize(_text: PAnsiChar; text_end: PAnsiChar; hide_text_after_double_hash: Boolean;
  wrap_width: Single): ImVec2;
Begin
...
Class Procedure ImGui.ColorConvertRGBtoHSV(r: Single; g: Single; b: Single; out_h: Psingle;
  out_s: Psingle; out_v: Psingle);
Begin
  igColorConvertRGBtoHSV(r, g, b, out_h, out_s, out_v);
End;

Class Procedure ImGui.ColorConvertHSVtoRGB(h: Single; s: Single; v: Single; out_r: Psingle;
  out_g: Psingle; out_b: Psingle);
Begin
